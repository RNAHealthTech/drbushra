  ...
  return (
    <div className="bg-white text-pink-700 min-h-screen p-8">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">Dr. Bushra Zahoor, a gold medalist MBBS and renowned psychiatrist, offers exceptional mental health services at Asiaz Hospital in Green Park. With her extensive experience and empathetic approach, she has become the most sought-after mental health professional in South Delhi.</p>
      </section>
      <section className="mb-8">
      ...
      <section>
        ...
        <p className="mt-4">Experience world-class psychiatric care in South Delhi. Schedule your appointment with Dr. Bushra Zahoor at Asiaz Hospital today!</p>
      </section>
    </div>
  );
};
