  ...
  return (
    <div className="bg-white text-pink-700 min-h-screen p-8">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">Dr. Bushra Zahoor, a gold medalist MBBS, brings her expertise to South Delhi, offering top-tier psychiatric treatments at Asiaz Hospital. Her approach combines cutting-edge medical knowledge with deep empathy for her patients, addressing a wide range of mental health concerns.</p>
      </section>
      <section className="mb-8">
      ...
      <section>
        <h3 className="text-xl font-semibold mb-4">Why Choose Dr. Bushra at Asiaz Hospital?</h3>
        ...
        <p className="mt-4">Experience exceptional psychiatric care in South Delhi. Schedule your appointment with Dr. Bushra Zahoor at Asiaz Hospital today!</p>
      </section>
    </div>
  );
};
